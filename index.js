...
async function connectToWA() {;
	console.log("Connecting KING-SANDESH-MD...");
    const {
        version,
        isLatest
    ...
    conn.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            console.log('KING-SANDESH-MD Plugins installed ✅')
            console.log('KING-SANDESH-MD Bot connected ✅')
...
let up = "*🫧 KING-SANDESH-MD FREE MINI BOT CONNECTED SUCCESSFULLY ☑️*\n\n𝙿𝚁𝙴𝙵𝙸𝚇 :-" + prefix + "\n𝙼𝙾𝙳𝙴 :- " + mode + "\n𝚂𝚃𝙰𝚃𝚄𝚂 𝚁𝙴𝙰𝙳 :-" + statusRead + "\n\n> ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴘʀᴏꜰᴇꜱꜱᴏʀ ꜱᴀɴᴅᴇꜱʜ ʙʜᴀꜱʜᴀɴᴀ";
...
if (metadata.viewer_metadata === null) {
  ...
  console.log("KING-SANDESH-MD CHANNEL FOLLOW ✅");
}
...
if(senderNumber.includes("94741259325")){
if(isReact) return
m.react("👨‍💻")
}
...
app.get("/", (req, res) => {
res.send("KING-SANDESH-MD CONNECTED SUCCESSFULY...💀");
});
app.listen(port, () => console.log(`KING-SANDESH-MD Server listening on port http://localhost:` + port));
setTimeout(() => {
connectToWA()
}, 3000);
